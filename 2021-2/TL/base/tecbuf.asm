...
L1:
        ...
        MOV     AL, [bx+tecla]
        mov     [tecla_u],al
        ; tem cara de ser a parte da conversão para ascii
        MOV     BL, 16
        DIV     BL
        ADD     Al, 30h ; realmente é a parte da conversão
        CMP     AL, 3Ah                                                                                              
        JB      continua
        ADD     AL, 07h
...
continua1:
        ...
        int     21h
        CMP     BYTE [tecla_u], 81h ; é o break do ESC (se soltar o esc, ele sai)
        JE      L2
        JMP     L1
