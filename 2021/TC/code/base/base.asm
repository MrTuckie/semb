...
botao_abrir_rec2: ; implementacao 1
    ...
    mov byte[x_anterior_b], 0 
    mov word[coluna_grafico_b], 0
    ; limpar [decimal] aqui
...
botao_fir1_2:
	...
	call msg_fir2
	call msg_fir3
    ; Insira a escala do gráfico aqui
    mov byte[escala_b], 4
    call plota_grafico_b
    call msg_fir1
    ...
    cria_divisorias:
		...
		plota_grafico:
			...
			coluna_valida:	
                ...
                ; este -1 é pra não dar problemas com overflow do gráfico do lado direito
                mov bx, -1
                mov cx, 512	
                mov byte[cor],branco_intenso
			...
			coluna_valida_b:	
                ...
                printar_b:
                    ...
                    segue_sem_resetar_b:
                        ...
                        mov ax, bx
                        add ax,1
                        mov byte[x_anterior_b], bl
                        push ax

                        push bx			
                        mov bx, word[coluna_grafico_b]
                        mov dh, 0
                        ; Mude a linha abaixo para alterar a fonte de dados
                        mov dl, byte[decimal+bx]
                        inc bx
                        mov word[coluna_grafico_b], bx			
                        pop bx
            ...
            loop_anda_n: ; vai rodar 4096 vezes
                ...
                loop_anda_k:
                    ...
                    cmp bx,dx ; se !(n>=k)
                        jnge out_loop_anda_k ; sai do loop
