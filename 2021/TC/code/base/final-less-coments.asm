...
;;;;;;;;;;;;;;;;;;;;;;;;;;; FIM DO SETUP DOS BOTÕES ;;;;;;;;;;;;;;;;;;;;;;;;;;;

;;;;;;;;;;;;;;;;;;;;;;;;;;; FUNÇÕES PARA ABRIR O ARQUIVO ;;;;;;;;;;;;;;;;;;;;;;;;;;;
    abre_arquivo:
        ; Salvando contexto
        pushf
        push ax
...
; exceto pelas tags que devem ser unicas
            ...
            loop_anda_n_a: ; vai rodar 4096 vezes
                ...
                loop_anda_k_a:
                    ...
                    mov bx,word[n_aux]              ; bx se torna n
                    ...
                    inc word[k_ant]             ; k+=1
                    mov dx,word[k_ant]
                    mov bx, word[n_aux]             ; joga o valor de n de volta no bx   
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
        ...
        filtra_2:
            ...
            loop_anda_n_b: 
                ...
                mov     ax, word[filtrado_aux]
                mov		bx, word[num_count_2]   
                mov 	word[filtrado+bx],ax    
                inc     bx
                inc 	bx                      
                mov		word[num_count_2],bx	    
                mov word[filtrado_aux], 0
